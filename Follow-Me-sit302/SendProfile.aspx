<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendProfile.aspx.cs" Inherits="Follow_Me_sit302.SendProfile" %>
						...
						<div class="col-lg-6 col-md-12">
							<div class="card card-nav-tabs">
								<div class="card-header" data-background-color="black">
                                    <h4 class="title">Send Profile</h4>
									<p class="category">Send your completed profile to a business</p>								
								</div>
                                    ...
                                    <div class="row">
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
                                                    <asp:DropDownList ID="ddlSendPro" runat="server">
                                                        <asp:ListItem Text ="Select Business" Value="0"></asp:ListItem>
                                                        <asp:ListItem Text ="Optus" Value="1"></asp:ListItem>
                                                        <asp:ListItem Text ="Telstra" Value="2"></asp:ListItem>
                                                        <asp:ListItem Text ="Woolworths" Value="3"></asp:ListItem>
                                                    </asp:DropDownList>
												</div>
	                                        </div>
	                                    </div>
                                        ...
                                        <asp:Button ID="btnSend" runat="server" Text="Send Profile" CssClass="btn btn-primary pull-right" OnClick="btnSend_Click" />
