<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="client.aspx.cs" Inherits="Follow_Me_sit302.client" %>
						...
						<div class="col-lg-6 col-md-12">
							<div class="card card-nav-tabs">
								<div class="card-header" data-background-color="black">
                                    <h4 class="title">Get Client Details</h4>
									<p class="category">Fill in the Follow Me Id you wish to find</p>								
								</div>
